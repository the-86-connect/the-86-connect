  ...
  const submissionBlocks = data.submissions.length
    ? data.submissions
        .map((s, i) => {
          ...
          const imageAtts = s.attachments.filter((a) => isImageMime(a.mimeType));
          const nonImageAtts = s.attachments.filter(
          ...
          const imagesSection =
            imageAtts.length > 0
              ? `<h4 style="margin:14px 0 6px 0;color:#475569;">Attached Images</h4>
<table>
  ...
  .join("")}
          ...
          const nonImageLinks =
            nonImageAtts.length > 0
              ? `<p style="margin-top:10px;font-size:10pt;color:#475569;"><strong>Document Links (Cloudinary):</strong></p>
...
<p style="margin-top:24px;font-size:9pt;color:#94a3b8;">Generated by 86Connect on ${new Date().toLocaleString("en-US")}. This document contains all personal data we hold for your account.</p>
</body>
</html>`;
